...
class MenuListener implements EventSubscriberInterface
{
    ...
    public const SQLI_ADMIN_MENU_CONTENT_LIST = "sqli_admin__menu_content_list";
    ...
    public function onMainMenuBuild(ConfigureMenuEvent $event): void
    {
        ...
        //SQLI Content Listing
        $menu[self::SQLI_ADMIN_MENU_ROOT]->addChild(
            self::SQLI_ADMIN_MENU_CONTENT_LIST,
            [
                'label' => self::SQLI_ADMIN_MENU_CONTENT_LIST,
                'route' => 'sqli_eztoolbox_all_content_list',
            ]
        )->setExtra('translation_domain', 'sqli_admin');
    }
}
